...
function humanizeAuthError(message: string): string {
  ...
  if (lower.includes('email not confirmed')) {
    return 'Tu cuenta aún no está confirmada. Revisá tu email y hacé clic en el enlace de verificación.';
  }
  if (lower.includes('too many requests')) {
    return 'Demasiados intentos fallidos. Esperá unos minutos antes de intentar de nuevo.';
  }
...
export function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      setServerError(humanizeAuthError(message));
    }
  };
    ...
    <AuthLayout>
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Bienvenido de vuelta</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          ...
          <label className="flex items-center gap-2.5 cursor-pointer select-none group w-fit">
            <div className="relative flex items-center">
              ...
              />
              <div className="w-4 h-4 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 peer-checked:bg-primary-500 peer-checked:border-primary-500 transition-colors group-hover:border-primary-400" />
              {/* Custom checkmark */}
              <svg
            ...
            <span className="text-sm text-gray-600 dark:text-gray-400">Recordar mis datos</span>
          </label>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-white dark:bg-gray-900 text-gray-400">O ingresá con</span>
          </div>
        </div>
