import { Calculator, ScrollText, Tag, Smartphone, Settings, Wrench, Package, DollarSign } from 'lucide-react';
...
export function MobileNavBar({ activeTab, onTabChange }: MobileNavBarProps) {
  ...
  const allNavItems = [
    ...
    { id: 'prices',     icon: DollarSign,  label: 'Precios',   adminOnly: true  },
  ];
